                ...
                <div class="card-body">
                     <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="userType" class="form-control @error('usertype') is-invalid @enderror" id="usertype">
                                    ...
                                    <option value="State">SPCB</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('name') is-invalid @enderror" name="lastname" value="{{ old('firstname') }}" required autocomplete="firstname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('state') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                               ...
                               <option value="{{$items->state_name}}">{{$items->state_name}}</option>
                               @endforeach
